...
&nbsp;   
• Download github repo (`wget https://github.com/seb951/basic_unix/archive/master.zip`)  
...
• Commands can be combined (more later)  
...
• Let's symbolic link it so the computer knows where to find it (` ln /Users/jerry/master_basic_unix/fastagrep.pl /usr/local/bin/fastagrep.pl`)  
